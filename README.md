...
### 1. [The Difference Advantage](./the-difference-advantage/)
Why Being Different Creates Success Without the Grind

### 2. [Operating System Philosophy](./os-philosophy/)
Understanding the "Why" Behind the "What" of Operating Systems

### 3. [Inventing the LSM Tree](./lsm-tree-invention/)
